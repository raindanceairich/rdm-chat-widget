...
(() => {
  function createChat() {
    ...
    doc.open();
    doc.write(`
      <link href="https://cdn.jsdelivr.net/gh/raindanceairirch/rdm-chat-widget/style.css" rel="stylesheet" />
        ...
        input.addEventListener('keypress', async (e) => {
          if (e.key === 'Enter') {
            ...
            try {
              ...
              else appendMessage("No reply from AI.", 'bot');
            } catch (err) {
